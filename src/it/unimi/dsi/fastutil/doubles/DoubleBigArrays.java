...
public final class DoubleBigArrays {
	...
	private static void swap(final double[][] x, long a, long b, final long n) {
	...
	protected static class ForkJoinQuickSort extends RecursiveAction {
		...
		public ForkJoinQuickSort(final double[][] x, final long from, final long to) {
			this.from = from;
			this.to = to;
			this.x = x;
		}
	 ...
	 *            the index of the last element (exclusive) to be sorted.
	 */
	public static void parallelQuickSort(final double[][] x, final long from, final long to) {
	...
	protected static class ForkJoinQuickSortComp extends RecursiveAction {
		...
		public ForkJoinQuickSortComp(final double[][] x, final long from, final long to, final DoubleComparator comp) {
			this.from = from;
			this.to = to;
			this.x = x;
			this.comp = comp;
