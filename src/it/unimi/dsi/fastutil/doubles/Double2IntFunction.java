...
public interface Double2IntFunction extends Function<Double, Integer>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.doubles.Double2IntFunction andThen(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2IntFunction compose(it.unimi.dsi.fastutil.ints.Int2DoubleFunction before) {
		return k -> get(before.get(k));
	}
