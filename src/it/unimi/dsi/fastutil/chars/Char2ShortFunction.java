...
public interface Char2ShortFunction extends Function<Character, Short>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.chars.Char2IntFunction andThen(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction compose(it.unimi.dsi.fastutil.ints.Int2CharFunction before) {
		return k -> get(before.get(k));
	}
