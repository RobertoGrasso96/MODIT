...
public interface Char2IntFunction extends Function<Character, Integer>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.chars.Char2ByteFunction andThen(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction compose(it.unimi.dsi.fastutil.bytes.Byte2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2ShortFunction andThen(it.unimi.dsi.fastutil.ints.Int2ShortFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.chars.Char2IntFunction andThen(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2IntFunction compose(it.unimi.dsi.fastutil.ints.Int2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction andThen(it.unimi.dsi.fastutil.ints.Int2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2IntFunction compose(it.unimi.dsi.fastutil.longs.Long2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2CharFunction andThen(it.unimi.dsi.fastutil.ints.Int2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2IntFunction compose(it.unimi.dsi.fastutil.chars.Char2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2FloatFunction andThen(it.unimi.dsi.fastutil.ints.Int2FloatFunction after) {
		return k -> after.get(get(k));
	}
