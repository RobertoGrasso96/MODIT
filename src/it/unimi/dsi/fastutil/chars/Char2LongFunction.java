...
public interface Char2LongFunction extends Function<Character, Long>, java.util.function.IntToLongFunction {
	...
	default it.unimi.dsi.fastutil.chars.Char2ByteFunction andThen(it.unimi.dsi.fastutil.longs.Long2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.chars.Char2IntFunction andThen(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(it.unimi.dsi.fastutil.ints.Int2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction andThen(it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.chars.Char2CharFunction andThen(it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(get(k));
	}
