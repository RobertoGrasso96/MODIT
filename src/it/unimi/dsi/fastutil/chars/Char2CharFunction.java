...
public interface Char2CharFunction extends Function<Character, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.chars.Char2ByteFunction andThen(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.chars.Char2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2CharFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction andThen(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.chars.Char2CharFunction andThen(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}
