...
public interface Long2ByteFunction extends Function<Long, Byte>, java.util.function.LongToIntFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2CharFunction after) {
		return k -> after.get(get(k));
	}
