...
public interface Long2DoubleFunction extends Function<Long, Double>, java.util.function.LongToDoubleFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(
			it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
