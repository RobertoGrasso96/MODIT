...
public interface Long2LongFunction extends Function<Long, Long>, java.util.function.LongUnaryOperator {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThen(it.unimi.dsi.fastutil.longs.Long2ByteFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction compose(
			it.unimi.dsi.fastutil.bytes.Byte2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2ShortFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2ShortFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.shorts.Short2LongFunction compose(
			it.unimi.dsi.fastutil.shorts.Short2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThen(it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction compose(
			it.unimi.dsi.fastutil.longs.Long2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThen(it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction compose(
			it.unimi.dsi.fastutil.chars.Char2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2FloatFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2FloatFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction compose(
			it.unimi.dsi.fastutil.floats.Float2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2DoubleFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2DoubleFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.doubles.Double2LongFunction compose(
			it.unimi.dsi.fastutil.doubles.Double2LongFunction before) {
		return k -> get(before.get(k));
	}
	default <T> it.unimi.dsi.fastutil.longs.Long2ObjectFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Object2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Object2LongFunction<T> before) {
		return k -> get(before.getLong(k));
	}
	default <T> it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> before) {
		return k -> get(before.getLong(k));
	}
}
