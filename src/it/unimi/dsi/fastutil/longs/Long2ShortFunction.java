...
public interface Long2ShortFunction extends Function<Long, Short>, java.util.function.LongToIntFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
