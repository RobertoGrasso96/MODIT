...
public interface Long2CharFunction extends Function<Long, Character>, java.util.function.LongToIntFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThen(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThen(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThen(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}
