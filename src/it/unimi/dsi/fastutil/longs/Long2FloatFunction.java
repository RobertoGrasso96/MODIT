...
public interface Long2FloatFunction extends Function<Long, Float>, java.util.function.LongToDoubleFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThen(
	...
	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThen(it.unimi.dsi.fastutil.floats.Float2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2FloatFunction compose(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThen(
	...
	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThen(
