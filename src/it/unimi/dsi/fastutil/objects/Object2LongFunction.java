...
public interface Object2LongFunction<K> extends Function<K, Long>, java.util.function.ToLongFunction<K> {
	...
	default it.unimi.dsi.fastutil.objects.Object2ByteFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2ByteFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2ShortFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2ShortFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.shorts.Short2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2IntFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2LongFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2CharFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2FloatFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2FloatFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction compose(
	...
	default it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> andThen(
			it.unimi.dsi.fastutil.longs.Long2DoubleFunction after) {
		return k -> after.get(getLong(k));
	}
	default it.unimi.dsi.fastutil.doubles.Double2LongFunction compose(
	...
	default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction<K, T> andThen(
			it.unimi.dsi.fastutil.longs.Long2ObjectFunction<T> after) {
		return k -> after.get(getLong(k));
	}
	default <T> it.unimi.dsi.fastutil.objects.Object2LongFunction<T> compose(
	...
	default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<K, T> andThen(
			it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<T> after) {
		return k -> after.get(getLong(k));
	}
	default <T> it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> compose(
