...
public interface Byte2ByteFunction extends Function<Byte, Byte>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2CharFunction after) {
		return k -> after.get(get(k));
	}
