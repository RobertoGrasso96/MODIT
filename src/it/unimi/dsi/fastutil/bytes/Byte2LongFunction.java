...
public interface Byte2LongFunction extends Function<Byte, Long>, java.util.function.IntToLongFunction {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction andThen(it.unimi.dsi.fastutil.longs.Long2ByteFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction compose(
			it.unimi.dsi.fastutil.bytes.Byte2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2ShortFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2ShortFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.shorts.Short2LongFunction compose(
			it.unimi.dsi.fastutil.shorts.Short2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction andThen(it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction compose(
			it.unimi.dsi.fastutil.longs.Long2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction andThen(it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction compose(
			it.unimi.dsi.fastutil.chars.Char2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2FloatFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2FloatFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction compose(
			it.unimi.dsi.fastutil.floats.Float2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2DoubleFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.doubles.Double2LongFunction compose(
			it.unimi.dsi.fastutil.doubles.Double2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default <T> it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Object2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Object2ByteFunction<T> before) {
		return k -> get(before.getByte(k));
	}
	default <T> it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Reference2ByteFunction<T> before) {
		return k -> get(before.getByte(k));
	}
}
