...
public interface Byte2CharFunction extends Function<Byte, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction andThen(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction andThen(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction andThen(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}
