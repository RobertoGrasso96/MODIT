...
public interface Byte2FloatFunction extends Function<Byte, Float>, java.util.function.IntToDoubleFunction {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction andThen(
	...
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(it.unimi.dsi.fastutil.floats.Float2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2FloatFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction andThen(
	...
	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction andThen(
