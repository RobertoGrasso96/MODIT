...
public interface Byte2DoubleFunction extends Function<Byte, Double>, java.util.function.IntToDoubleFunction {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(
			it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
