...
public interface Byte2ShortFunction extends Function<Byte, Short>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThen(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction compose(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}
