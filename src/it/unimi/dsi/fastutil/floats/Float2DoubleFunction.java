...
public interface Float2DoubleFunction extends Function<Float, Double>, java.util.function.DoubleUnaryOperator {
	...
	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThen(
			it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction compose(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}
