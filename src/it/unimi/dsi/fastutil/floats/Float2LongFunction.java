...
public interface Float2LongFunction extends Function<Float, Long>, java.util.function.DoubleToLongFunction {
	...
	default it.unimi.dsi.fastutil.floats.Float2ByteFunction andThen(
	...
	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction compose(
			it.unimi.dsi.fastutil.bytes.Byte2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2ShortFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2ShortFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.shorts.Short2LongFunction compose(
			it.unimi.dsi.fastutil.shorts.Short2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThen(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2LongFunction compose(
			it.unimi.dsi.fastutil.longs.Long2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2CharFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2LongFunction compose(
			it.unimi.dsi.fastutil.chars.Char2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2FloatFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2FloatFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction compose(
			it.unimi.dsi.fastutil.floats.Float2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2DoubleFunction andThen(
			it.unimi.dsi.fastutil.longs.Long2DoubleFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.doubles.Double2LongFunction compose(
			it.unimi.dsi.fastutil.doubles.Double2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default <T> it.unimi.dsi.fastutil.floats.Float2ObjectFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Object2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Object2FloatFunction<T> before) {
		return k -> get(before.getFloat(k));
	}
	default <T> it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<T> andThen(
	...
	default <T> it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> compose(
			it.unimi.dsi.fastutil.objects.Reference2FloatFunction<T> before) {
		return k -> get(before.getFloat(k));
	}
}
