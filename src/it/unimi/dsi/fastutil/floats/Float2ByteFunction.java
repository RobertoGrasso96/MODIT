...
public interface Float2ByteFunction extends Function<Float, Byte>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction compose(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}
