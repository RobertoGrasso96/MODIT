...
public interface Float2IntFunction extends Function<Float, Integer>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.floats.Float2ByteFunction andThen(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThen(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2IntFunction compose(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.floats.Float2LongFunction andThen(it.unimi.dsi.fastutil.ints.Int2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.floats.Float2CharFunction andThen(it.unimi.dsi.fastutil.ints.Int2CharFunction after) {
		return k -> after.get(get(k));
	}
