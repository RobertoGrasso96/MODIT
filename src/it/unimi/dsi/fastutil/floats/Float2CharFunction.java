...
public interface Float2CharFunction extends Function<Float, Character>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}
