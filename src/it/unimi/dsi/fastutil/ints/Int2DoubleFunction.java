...
public interface Int2DoubleFunction extends Function<Integer, Double>, java.util.function.IntToDoubleFunction {
	...
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction andThen(
	...
	default it.unimi.dsi.fastutil.ints.Int2IntFunction andThen(it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction compose(it.unimi.dsi.fastutil.ints.Int2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction andThen(
	...
	default it.unimi.dsi.fastutil.ints.Int2CharFunction andThen(
