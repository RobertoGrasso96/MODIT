...
public interface Int2ByteFunction extends Function<Integer, Byte>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction compose(it.unimi.dsi.fastutil.bytes.Byte2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2ShortFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.ints.Int2IntFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction compose(it.unimi.dsi.fastutil.ints.Int2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction compose(it.unimi.dsi.fastutil.longs.Long2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2ByteFunction compose(it.unimi.dsi.fastutil.chars.Char2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2FloatFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2FloatFunction after) {
		return k -> after.get(get(k));
	}
