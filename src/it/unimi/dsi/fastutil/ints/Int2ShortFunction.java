...
public interface Int2ShortFunction extends Function<Integer, Short>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction andThen(it.unimi.dsi.fastutil.shorts.Short2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.ints.Int2IntFunction andThen(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction compose(it.unimi.dsi.fastutil.ints.Int2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction andThen(it.unimi.dsi.fastutil.shorts.Short2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.ints.Int2CharFunction andThen(it.unimi.dsi.fastutil.shorts.Short2CharFunction after) {
		return k -> after.get(get(k));
	}
