...
public interface Int2CharFunction extends Function<Integer, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction andThen(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction compose(it.unimi.dsi.fastutil.bytes.Byte2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ShortFunction andThen(it.unimi.dsi.fastutil.chars.Char2ShortFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.ints.Int2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction andThen(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.longs.Long2CharFunction compose(it.unimi.dsi.fastutil.longs.Long2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction andThen(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.chars.Char2CharFunction compose(it.unimi.dsi.fastutil.chars.Char2IntFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2FloatFunction andThen(it.unimi.dsi.fastutil.chars.Char2FloatFunction after) {
		return k -> after.get(get(k));
	}
