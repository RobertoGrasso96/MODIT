...
public interface Short2LongFunction extends Function<Short, Long>, java.util.function.IntToLongFunction {
	...
	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThen(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2LongFunction compose(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}
