...
public interface Short2ByteFunction extends Function<Short, Byte>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThen(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction compose(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}
