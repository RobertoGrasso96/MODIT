...
public interface Short2IntFunction extends Function<Short, Integer>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.shorts.Short2ByteFunction andThen(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) {
	...
	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThen(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2IntFunction compose(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}
	default it.unimi.dsi.fastutil.shorts.Short2LongFunction andThen(it.unimi.dsi.fastutil.ints.Int2LongFunction after) {
		return k -> after.get(get(k));
	}
	...
	default it.unimi.dsi.fastutil.shorts.Short2CharFunction andThen(it.unimi.dsi.fastutil.ints.Int2CharFunction after) {
		return k -> after.get(get(k));
	}
