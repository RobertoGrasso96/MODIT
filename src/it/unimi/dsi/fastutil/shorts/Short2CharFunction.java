...
public interface Short2CharFunction extends Function<Short, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThen(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}
	default it.unimi.dsi.fastutil.ints.Int2CharFunction compose(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}
